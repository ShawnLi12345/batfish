...
public class SubnetworkPoliciesQuestion extends Question {
  ...
  @JsonCreator
  private static SubnetworkPoliciesQuestion create(
          @JsonProperty(PROP_NODES) @Nullable String nodes) {
    return new SubnetworkPoliciesQuestion(nodes);
  }

  public SubnetworkPoliciesQuestion(@Nullable String nodes) {
    _nodes = nodes;
    _nodeSpecifier =
  ...
  public boolean equals(@Nullable Object o) {
    if (!(o instanceof SubnetworkPoliciesQuestion)) {
      return false;
    }
    SubnetworkPoliciesQuestion that = (SubnetworkPoliciesQuestion) o;
