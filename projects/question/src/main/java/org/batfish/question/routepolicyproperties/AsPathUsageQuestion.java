...
public class AsPathUsageQuestion extends Question {
  ...
  @JsonCreator
  private static AsPathUsageQuestion create(
          @JsonProperty(PROP_NODES) @Nullable String nodes) {
    return new AsPathUsageQuestion(nodes);
  }

  public AsPathUsageQuestion(@Nullable String nodes) {
    _nodes = nodes;
    _nodeSpecifier =
  ...
  @Override
  public boolean getDataPlane() {return true;}
  @Override
  ...
  public boolean equals(@Nullable Object o) {
    if (!(o instanceof AsPathUsageQuestion)) {
      return false;
    }
    AsPathUsageQuestion that = (AsPathUsageQuestion) o;
