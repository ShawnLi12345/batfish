...
public class TiebreakerUsageQuestion extends Question {
  ...
  @JsonCreator
  private static TiebreakerUsageQuestion create(
          @JsonProperty(PROP_NODES) @Nullable String nodes) {
    return new TiebreakerUsageQuestion(nodes);
  }

  public TiebreakerUsageQuestion(@Nullable String nodes) {
    _nodes = nodes;
    _nodeSpecifier =
  ...
  public boolean equals(@Nullable Object o) {
    if (!(o instanceof TiebreakerUsageQuestion)) {
      return false;
    }
    TiebreakerUsageQuestion that = (TiebreakerUsageQuestion) o;
