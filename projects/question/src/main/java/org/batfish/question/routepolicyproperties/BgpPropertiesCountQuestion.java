...
public class BgpPropertiesCountQuestion extends Question {
  ...
  @JsonCreator
  private static BgpPropertiesCountQuestion create(
          @JsonProperty(PROP_NODES) @Nullable String nodes) {
    return new BgpPropertiesCountQuestion(nodes);
  }

  public BgpPropertiesCountQuestion(@Nullable String nodes) {
    _nodes = nodes;
    _nodeSpecifier =
  ...
  public boolean equals(@Nullable Object o) {
    if (!(o instanceof BgpPropertiesCountQuestion)) {
      return false;
    }
    BgpPropertiesCountQuestion that = (BgpPropertiesCountQuestion) o;
